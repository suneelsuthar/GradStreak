        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              <img src="/icons/logo.svg" alt="GradStreak Logo" className="h-8 w-auto" />
              <span className="text-xl font-bold text-white">GradStreak</span>
            </Link>
            <p className="text-gray-400 text-sm">Empowering students to achieve academic excellence through consistent practice and smart learning.</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400 text-sm">Subscribe to our newsletter</p>
